...
namespace EJCFitnessGym.Data.Migrations
{
    ...
    [Migration("20260302054246_AddLinkedEquipmentToReplacementRequests")]
    partial class AddLinkedEquipmentToReplacementRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EJCFitnessGym.Models.Admin.ReplacementRequest", b =>
                {
                    ...
                    b.Property<int?>("LinkedEquipmentAssetId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EJCFitnessGym.Models.Finance.FinanceBudget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BranchId", "Year", "Month", "Category")
                        .IsUnique()
                        .HasDatabaseName("IX_FinanceBudgets_Branch_Period_Category")
                        .HasFilter("[BranchId] IS NOT NULL");

                    b.ToTable("FinanceBudgets", (string)null);
                });
            ...
            modelBuilder.Entity("EJCFitnessGym.Models.Finance.WeeklySalesAuditRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("BalanceCheckPassed")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("OutlierCheckPassed")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("SnapshotGateway")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SnapshotStaffCollected")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SnapshotTotalSales")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("SnapshotTransactionCount")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BranchId", "WeekStartUtc")
                        .IsUnique()
                        .HasDatabaseName("IX_WeeklySalesAudit_Branch_Week")
                        .HasFilter("[BranchId] IS NOT NULL");

                    b.ToTable("WeeklySalesAuditRecords", (string)null);
                });
